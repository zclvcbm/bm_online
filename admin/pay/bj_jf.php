...
else
{
    ...
    $sql = "select f.id,f.bmh,f.sfzh,f.jfzt,f.kskm,f.pxkm,f.ksfy,f.pxfy,f.qtfy,f.val2,u.studentid,u.name,u.tel,u.pic,u.stat from form_".$fid." as f inner join tf_users u on f.sfzh=u.username where classid='".$classid."' and jfzt=0 and stat=1";//给.$classid.加引号防止有字母的班打不出来信息
		//echo $sql;
    ...
    //先清空临时表
    $db->query("truncate table temp_bj");
    $db->query("truncate table temp_bj_del");
    //$db->query($sql_qk1);
    ...
    <table width="630" height="277" border="0" align="center" cellpadding="0"  cellspacing="0" bordercolor="#003366" bgcolor="#FFFFFF">
        <tr><td valign="top" align=left>
                <table width="630" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr> 
                        <td align="center" height="30"><b><?=$res[0]['kskm']?><?=$_POST['classid']?>班报名信息表</b></td>
                    </tr>
                    <tr>
                        <td align="left"><br>
...
<table width="700" border="1" cellspacing="0" cellpadding="0" align="center" style="font-size:36px; border-color:#333" >
    ...
    <tr style="font-size:13px;border-color:#333;height: 20px;"><td colspan=4 style=" font-size:13px;border-color:#333">合计:&nbsp;<?=$hjzfy?>元</td></tr><tr>
      <td height="64">班级代理人签名：</td></tr>
</table>
