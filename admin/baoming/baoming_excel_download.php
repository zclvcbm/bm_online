	...
	<td width="4%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">报考级别</span></div></td>
     ...
     ?>
      <tr>
            ...
            <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php if($db->f("jfzt")==1) echo "已缴费";else echo "未缴费";?></div></td>
            <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php if($db->f("shzt")==1) echo "审核通过";elseif($db->f("shzt")==0) echo "未审核"; else echo "审核未通过";?></div></td>
        </tr>
    <?php
    }
    ?>
