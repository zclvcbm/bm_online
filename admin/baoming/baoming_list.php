...
if ($_GET['del'] == 1 && empty($_GET['np']))
{
    ...
    if($db->affected_rows()>0)
    {
        ...
        $db->query("ROLLBACK");
        echo "<script>alert('删除失败');window.location.href='baoming_list.php?fid=".intval($_GET['fid'])."'</script>";
    }
}
...
<input type="button" value="&nbsp;自定义导出&nbsp;" onClick="location.href='baoming_custom_input.php?fid=<?php echo $fid;?>'"  class="button small">
